...
//uudelleenohjataan, jos profiilin hallinnointisivu ei ole oma
        ...
        <div class="user-managment">
            ...
            <div class="edit-page-box1">
                ...
                <div class="user-form-container">
                    ...
                    <!-- // -->
                    <!-- näytä salasana -->
                    <button class="logout" id="pwdEdit" style="font-size: 16px;">Vaihda salasana</button>
                </div>
            </div>
        </div>
    </div>
